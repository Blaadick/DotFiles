sudo pacman -Syu
sudo pacman -S hyprpaper wl-clipboard brightnessctl playerctl git grim slurp flatpak nwg-look blueman code nautilus firefox torbrowser-launcher steam prismlauncher btop ttf-jetbrains-mono
